...
% 2007 by BAW. 
%
% This function duplicates the function mrvJavaFeature in the vistasoft
% repository. It is included in the teaching repository to avoid
% dependencies on vistasoft. In particular, the function kspaceParamsGUI
% calls generalDialog (also copied from vistasoft), which in turn calls
% mrvJavaFeature. Ideally the kspace demo should be repogrammed using
